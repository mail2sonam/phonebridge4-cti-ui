...
import folders from "./MailIntegr/folders";
import labels from "./MailIntegr/labels";
import options from "./MailIntegr/options";
import mails from "./MailIntegr/mails";
import filters from "./MailIntegr/filters";
...
import SmsList from "../../Message/SmsList";
import ComposeSms from "../../Message/SmsCompose";
import SmsDetail from "../../Message/SmsDetail";


class TestMsgPage extends PureComponent {
    ...
    return <div className="gx-module-side">
      ...
      <div className="gx-module-side-header">
        <div className="gx-module-logo">
          ...
          <IntlMessages id="sidebar.mail.msgbox" />
        </div>
      </div>
    ...
    return (<div className="gx-module-box-column">
      {currentMail === null ?
        folderMails.length === 0 ?
          ...
          :
          <SmsList mails={folderMails} onStartSelect={this.onStartSelect.bind(this)}
            onMailSelect={this.onMailSelect.bind(this)}
            onMailChecked={this.onMailChecked.bind(this)} />
        :
        <SmsDetail mail={currentMail} onStartSelect={this.onStartSelect.bind(this)}
