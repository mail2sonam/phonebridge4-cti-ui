...
const SmsListItem = ({mail, onMailSelect, onMailChecked, onStartSelect}) => {

  localStorage.setItem("toMail", mail.number)
      ...
      <div className="gx-mail-list-info" onClick={() => {
        ...
        <div className="gx-module-list-content">
          <div className="gx-mail-user-des">
            ...
            <span className="gx-sender-name">{mail.number}</span>

            <span className="gx-toolbar-separator">&nbsp;</span>

            <span className="gx-d-inline-block gx-text-truncate gx-send-subject">{mail.message}</span>
