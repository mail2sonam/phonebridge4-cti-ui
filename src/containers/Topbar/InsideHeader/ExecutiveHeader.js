...
import { Button, Dropdown, Layout, Menu, message, Popover, Col } from 'antd';
...
import ExecutiveHorizontalNav from "../ExecutiveHorizontalNav";
...
export default connect(mapStateToProps, { toggleCollapsedSideNav, switchLanguage })(ExecutiveHeader);
